...
class Linear(nn.Linear, RelProp):
    def relprop(self, R, alpha):
        ...
        def f(w1, w2, x1, x2):
            ...
            # print(S1.sum())
            C1 = x1 * torch.autograd.grad(Z1, x1, S1)[0] #S1为初始梯度，乘到计算的梯度上
            # print(C1.sum(),C1.shape)
            # C1=x1*torch.autograd.grad(Z1,x1)[0]
        ...
        # print(activator_relevances.sum(),activator_relevances.shape,inhibitor_relevances.sum(),inhibitor_relevances.shape)
